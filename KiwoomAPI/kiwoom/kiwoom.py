...
class Kiwoom(QAxWidget):
    def __init__(self):
        ...
        # 이벤트 루프 관련 함수
        self.login_event_loop = QEventLoop()  # 로그인 담당
        self.get_deposit_loop = QEventLoop()  # 예수금 담당
        self.get_account_evaluation_balance_loop = QEventLoop()  # 계좌 평가

        # 계좌 관련 변수
        self.account_number = None
        self.total_buy_money = 0
        self.total_evalutaion_money = 0
        self.total_evalutaion_profit_and_loss_money = 0
        self.total_yield = 0
        ...
        self.login()
        input()
        self.get_account_info()  # 계좌 번호 얻어오기
        self.get_deposit_info()  # 예수금 관련 정보 얻어오기
        self.get_account_evaluation_balance()
    ...
    def event_collection(self):
        ...
        self.OnReceiveTrData.connect(self.tr_slot)  # 트랜잭션 관련 이벤트
